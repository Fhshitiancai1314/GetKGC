...
def parse_args_wn18rr(args=None):
    ...
    parser.add_argument('-pretrained_model', type=str, default='./bert-base-uncased', help='')
    parser.add_argument('-batch_size', default=128, type=int, help='Batch size')
    parser.add_argument('-val_batch_size', default=128, type=int, help='Batch size')
    parser.add_argument('-src_max_length', default=512, type=int, help='')
    parser.add_argument('-epoch', dest='epochs', type=int, default=500, help='Number of epochs')
    ...
    parser.add_argument('-embed_dim', default=144, type=int, help='')       # 4
    ...
    parser.add_argument('-k_h', dest='k_h', default=12, type=int, help='ConvE: k_h')
    parser.add_argument('-num_filt', dest='num_filt', default=200, type=int,
                        help='ConvE: Number of filters in convolution')
    parser.add_argument('-ker_sz', dest='ker_sz', default=7, type=int, help='ConvE: Kernel size to use')
    ...
    parser.add_argument('-use_log_ranks', action='store_true', help='')
    parser.add_argument('-n_lar', default=8, type=int, help='Number of LARs')
    parser.add_argument('-gamma', default=1., type=float, help='Margin loss: margin between pos and neg')
    ...
    parser.add_argument('-use_fp16', action='store_true', help='')
    parser.add_argument('-prompt_hidden_dim', default=-1, type=int, help='')
    parser.add_argument('-alpha_step', default=0.00001, type=float, help='')
...
def parse_args_fb(args=None):
    ...
    parser.add_argument('-dataset_path', type=str, default='/E22301291/CSProm-KG-main/data/processed')
    parser.add_argument('-jobid', type=str, default='XXXXXXXX')
    parser.add_argument('-dataset', dest='dataset', default='FB15k-237', help='Dataset to use, default: InferWiki16k')
    parser.add_argument('-gpu', type=str, default='0', help='Set GPU Ids : Eg: For CPU = -1, For Single GPU = 0')
    parser.add_argument('-seed', dest='seed', default=41504, type=int, help='Seed for randomization')
    parser.add_argument('-num_workers', type=int, default=4, help='Number of processes to construct batches')
    parser.add_argument('-save_dir', type=str, default='', help='')

    parser.add_argument('-pretrained_model', type=str, default='/E22301291/CSProm-KG-main/bert-base-uncased', help='')
    
    # batch_size
    parser.add_argument('-batch_size', default=128, type=int, help='Batch size')
    parser.add_argument('-val_batch_size', default=256, type=int, help='Batch size')
    parser.add_argument('-src_max_length', default=512, type=int, help='')
    # epoch
    ...
    parser.add_argument('-desc_max_length', default=40, type=int, help='')
    parser.add_argument('-prompt_length', default=10, type=int, help='')
    parser.add_argument('-embed_dim', default=156, type=int, help='')
